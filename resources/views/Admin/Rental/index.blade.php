                                        ...
                                        <table class="table table-bordered " id="category_table">
                                            ...
                                            <tbody>
                                                @foreach ($rental as $rent)
                                                    <tr>
                                                        <td>{{ $rent->title }}</td>
                                                        <td>{{ $rent->category->category_name ?? 'No Category' }}</td>
                                                        <td>{{ $rent->type }}</td>
                                                        <td>{{ $rent->size }}</td>
                                                        ...
                                                        <td>
                                                            @if ($rent->image)
                                                                <img src="{{ asset('storage/' . $rent->image) }}"
                                                                    alt="Rental Image" width="70" height="70"
                                                        ...
                                                        <td>
                                                            <a href="{{ route('edit.rental', $rent->id) }}"
                                                                class="btn btn-sm btn-primary">
                                                                <i class="fas fa-edit"></i>
                                                            </a>

                                                            <form action="{{ route('delete.rental', $rent->id) }}"
