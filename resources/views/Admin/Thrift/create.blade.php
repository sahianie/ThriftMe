                ...
                <div class="card-body">
                    <form action="{{ route('store.thrift') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="material" placeholder="Stuff" class="form-control"
                                        id="material" value="{{ old('material') }}" required>
                                    <span class="text-danger">
                                        @error('material')
                                            {{ $message }}
                                        @enderror
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="condition" name="condition">
                                        ...
                                        <option value="good condition"
                                            {{ old('condition') == 'good condition' ? 'selected' : '' }}>Good Condition
                                        </option>
                                    </select>
                                    <span class="text-danger">
                                        @error('condition')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="type" name="type">
                                        ...
                                        <option value="women" {{ old('type') == 'women' ? 'selected' : '' }}>Women
                                        </option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="price" placeholder="Price" class="form-control"
                                        id="price" value="{{ old('price') }}" required min="100">
                                    <span class="text-danger">
                                        @error('price')
                                            {{ $message }}
                                        @enderror
                        ...
                        <div class="mb-3 text-center">
                            <button class="btn submitCategory login-btn"
                                type="submit"><b>{{ !empty($data) ? 'Update Thrift' : 'Add Thrift' }}</b></button>
                        </div>
                    </form>
                </div>
            </div>
