@extends('Front.Master.master') {{-- apna layout --}}
                ...
                <div class="product-item">
                    <figure>
                        ...
                        <div class="pi-meta" style="height: auto; padding: 10px 0;">
                            <div class="pi-m-left">
                                <a href="{{ $product->type === 'rental' ? route('rental.detail', $product->id) : route('thrift.detail', $product->id) }}">
                                    <img src="{{ asset('Front/img/icons/eye.png') }}" alt="" style="cursor: pointer;">
                                </a>
                            ...
                            <div class="pi-m-right">
                                <form action="{{ $product->type === 'rental' ? route('unfavourite.rental', $product->id) : route('unfavourite.thrift', $product->id) }}" method="POST">
                                    @csrf
                                    @method('DELETE')
                    ...
                    <div class="product-info">
                        ...
                        <a href="{{ $product->type === 'rental' ? route('rental.order', $product->id) : route('thrift.order', $product->id) }}" class="site-btn btn-line">
