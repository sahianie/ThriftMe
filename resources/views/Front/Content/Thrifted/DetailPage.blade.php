        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 text-center">
                    <figure>
                        <img style="height:350px; width: 400px;" class="product-big-img"
                            src="{{ asset('storage/' . $thrift->image) }}" alt="{{ $thrift->title }}">
                    </figure>
                </div>
                ...
                <div class="col-lg-6 text-center">
                    <div class="product-content">
                        ...
                        <ul class="thrift-details"
                            style="display: inline-block; text-align: left; list-style: none; padding: 0;">
