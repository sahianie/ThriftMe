...
<section class="product-section spad">
    ...
    @foreach ($products as $product)
        <div class="mix col-lg-4 col-md-6 mb-4"> {{-- Same grid style as rental cards --}}
            ...
            <figure>
                        <img
                            ...
                            alt="{{ $product->title }}">
                        <div class="pi-meta d-flex justify-content-between align-items-center px-3" style="height: 50px;"> <!-- Reduced height -->
                            <div class="pi-m-left d-flex align-items-center">
                                <a href="{{ route('thrift.detail', $product->id) }}" style="text-decoration: none; color: inherit;">
                ...
                ? route('unfavourite.thrift', $product->id) 
                : route('favourite.thrift', $product->id) 
            }}" method="POST">
                                    @csrf
                                    @if($isFavourite)
                                    @method('DELETE')
