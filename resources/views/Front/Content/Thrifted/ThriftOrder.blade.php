                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    <input style="background-color: #f3f4f6; border: 1px solid #ccc;" type="text"
                                ...
                                <div class="col-md-12 mb-3">
                                    <input style="background-color: #f3f4f6; border: 1px solid #ccc;" type="text"
                                        ...
                                        placeholder="Type your complete authentic address here *"
                                        value="{{ old('address') }}">
                                    @error('address')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                ...
                                <div class="col-md-12 mb-3">
                                    <input style="background-color: #f3f4f6; border: 1px solid #ccc;" type="text"
                                        id="Contact" name="contact" placeholder="Contact *" value="{{ old('contact') }}">
                                    @error('contact')
                                        <small style="color: red;">{{ $message }}</small>
                                    @enderror
                                </div>
